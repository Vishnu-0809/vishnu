      ...
      child: Column(
        children: [
            ...
            Container(
                ...
                child: Image.network(
                  ...
                  errorBuilder: (context, error, stackTrace) => const Center(
                      child: Text('Sorry couldn\'t show the product image')),
                )),
            AnimatedContainer(
          ...
          AnimatedContainer(
            ...
            alignment:
                _isContainerBig2 ? Alignment.center : Alignment.topCenter,
            child: Image.asset(
                      ...
                      showDialog(
                          ...
                          builder: (context) {
                            return AlertDialog(
                                ...
                                content: widget.snapshot.details["batchType"] !=
                                        null
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    temp_class.details["imageQrOnProd"] =
                        widget.snapshot.details["imageQrOnProd"];
                    ...
                    temp_class.details["additionalImageDetails"] =
                        widget.snapshot.details["additionalImageDetails"];
                    ...
                    temp_class.details['manuWebsiteLink'] =
                        widget.snapshot.details['manuWebsiteLink'];
                    temp_class.bill = widget.snapshot.bill;
                    print("--------------------");
                    print(temp_class.bill);
                    Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) =>
                          ProdDetails(link: widget.link, snapshot: temp_class),
                    ));
                  },
                  style: ElevatedButton.styleFrom(
                      primary: Colors.transparent,
