      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            child: Text(
              "Please scan 1st QR code which is on the box/wrapper of the produt before scanning the 2nd QR code",
              style: TextStyle(
                color: Color(0xff002060),
                fontSize: 10.5,
                fontFamily: "Poppins Medium",
                ...
                child: ElevatedButton(
                  onPressed: () {
                    if (snapshot.details["expiry"] == null) {
                      ...
                      String temp = snapshot.details["expiry"].substring(0, 10);
