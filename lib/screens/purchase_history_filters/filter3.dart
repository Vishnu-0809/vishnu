...
class PurchaseHistoryFIlter3 extends StatefulWidget {
  const PurchaseHistoryFIlter3({
    super.key,
    // required this.
  ...
  @override
  State<PurchaseHistoryFIlter3> createState() => _PurchaseHistoryFIlter3State();
}

class _PurchaseHistoryFIlter3State extends State<PurchaseHistoryFIlter3> {
//  String link = "";
...
//  print(difference);
  ...
  if(temp.substring(0, 4)==((DateTime.now().year)-2).toString())
  {
