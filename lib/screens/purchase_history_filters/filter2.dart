...
class PurchaseHistoryFIlter2 extends StatefulWidget {
  const PurchaseHistoryFIlter2({
    super.key,
    // required this.
  ...
  @override
  State<PurchaseHistoryFIlter2> createState() => _PurchaseHistoryFIlter2State();
}

class _PurchaseHistoryFIlter2State extends State<PurchaseHistoryFIlter2> {
//  String link = "";
...
//  print(difference);
  ...
  if(temp.substring(0, 4)==((DateTime.now().year)-1).toString())
  {
