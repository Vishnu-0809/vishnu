...
class PurchaseHistoryFIlter4 extends StatefulWidget {
  const PurchaseHistoryFIlter4({
    super.key,
    // required this.
  ...
  @override
  State<PurchaseHistoryFIlter4> createState() => _PurchaseHistoryFIlter4State();
}

class _PurchaseHistoryFIlter4State extends State<PurchaseHistoryFIlter4> {
//  String link = "";
...
//  print(difference);
  ...
  if(temp.substring(0, 4)==((DateTime.now().year)-3).toString())
  {
