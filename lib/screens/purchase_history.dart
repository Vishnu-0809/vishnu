...
// final connectivityResult = await (Connectivity().checkConnectivity());
  ...
  Future getSearchData() async {
    if (MOB_not_EM!) {
      final token =
          await createAlbumPurchaseHistoryDetailsMobile("mobile", ID!);
      ...
      for (int i = 0; i < responseData["data"].length; i++) {
        ...
        temp_class.details["preSaleCode"] =
            responseData["data"][i]["preSaleCode"];
        temp_class.details["postSaleCode"] =
        ...
        temp_class.details["warrantyApp"] =
            responseData["data"][i]["warrantyApp"];
...
// });
      ...
      final token = await createAlbumPurchaseHistoryDetailsEmail("email", ID!);
                                                                ...
                                                                child:
                                                                  ...
                                                                  onPressed:
                                                                    ...
                                                                    if (filter1 ==
                                                                        true) {
                                                                      Navigator.of(context).push(MaterialPageRoute(
                                                                          builder: (context) => PurchaseHistoryFIlter1(
                                                                                DetailsList: SearchorderedDetailsList,
                                                                              )));
                                                                    } else if (filter2 ==
                                                                        true) {
                                                                      Navigator.of(context).push(MaterialPageRoute(
                                                                          builder: (context) => PurchaseHistoryFIlter2(
                                                                                DetailsList: SearchorderedDetailsList,
                                                                              )));
                                                                    } else if (filter3 ==
                                                                        true) {
                                                                      Navigator.of(context).push(MaterialPageRoute(
                                                                          builder: (context) => PurchaseHistoryFIlter3(
                                                                                DetailsList: SearchorderedDetailsList,
                                                                              )));
                                                                    } else if (filter4 ==
                                                                        true) {
                                                                      Navigator.of(context).push(MaterialPageRoute(
                                                                          builder: (context) => PurchaseHistoryFIlter4(
                                                                                DetailsList: SearchorderedDetailsList,
                                                                              )));
                                                                    } else if (filter5 ==
                                                                        true) {
                                                                      Navigator.of(context).push(MaterialPageRoute(
                                                                          builder: (context) => PurchaseHistoryFIlter5(
                                                                                DetailsList: SearchorderedDetailsList,
                                                                              )));
                                                                    } else {
...
// }
                              ...
                              String prevDate() {
                                if (index != 0) {
                                  final sea0 =
                                      SuggestionsDetailsList[index - 1];
                                  String temp0 = sea0.details["purchaseDate"]
                                      .substring(0, 10);
                                  String res0 = temp0.substring(8, 10) +
                                      ...
                                      "-" +
                                      temp0.substring(0, 4);
                                  DateTime purchasedDate0 = DateTime(
                                      int.parse(temp0.substring(0, 4)),
                                      int.parse(temp0.substring(5, 7)),
                                      int.parse(temp0.substring(8, 10)));
                                  String Dayinwords0 = days[int.parse(
                                      purchasedDate0.weekday.toString())]!;
                                  String Day0 = temp0.substring(8, 10);
                                  // final d=days[01];
                                  String Month0 = months[int.parse(
                                      purchasedDate0.month.toString())]!;
                                  String year0 = temp0.substring(2, 4);
                                  String FinalPurchaseDate0 = "On" +
                                      " " +
                                      Dayinwords0 +
                                      " " +
                                      "," +
                              ...
                              String res = temp.substring(8, 10) +
                                  ...
                                  "-" +
                                  temp.substring(0, 4);
                              DateTime purchasedDate = DateTime(
                                  int.parse(temp.substring(0, 4)),
                                  int.parse(temp.substring(5, 7)),
                                  int.parse(temp.substring(8, 10)));
                              String Dayinwords = days[
                                  int.parse(purchasedDate.weekday.toString())]!;
                              String Day = temp.substring(8, 10);
                              // final d=days[01];
                              String Month = months[
                                  int.parse(purchasedDate.month.toString())]!;
                              String year = temp.substring(2, 4);
                              String FinalPurchaseDate = "On" +
                                  " " +
                                  Dayinwords +
                                  " " +
                                  "," +
                                                                    ...
                                                                    TextButton(
                                                                        ...
                                                                        style: ButtonStyle(
                                                                            foregroundColor: MaterialStateProperty.all<Color>(Color.fromARGB(
                                                                                ...
                                                                                119)),
                                                                            shape:
                                                                                MaterialStateProperty.all<RoundedRectangleBorder>(RoundedRectangleBorder(borderRadius: BorderRadius.circular(8.0), side: BorderSide(color: Color.fromARGB(255, 123, 119, 119))))),
                                                                        onPressed: () {
                                                                          Navigator.of(context).push(MaterialPageRoute(
